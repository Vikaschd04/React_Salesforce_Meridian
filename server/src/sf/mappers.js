...
export function productFromSf(record) {
  ...
  return {
    ...
    // Guided-selling attributes (";"-delimited Text on Product2, like tasting notes)
    body: record.Body__c || '',
    flavorProfile: parseNotes(record.Flavor_Profile__c),
    brewMethods: parseNotes(record.Brew_Methods__c),
