 ...
 *
 * Conventions:
 *  - Money is stored as USD dollars (a decimal Number). The client never sets prices.
 ...
 *  - `body` / `flavorProfile` / `brewMethods` power guided selling ("Find your
 *    coffee"); in Salesforce they live on Product2 as ';'-delimited Text
 *    (Body__c / Flavor_Profile__c / Brew_Methods__c). See server/src/lib/guided.js.
 */
...
export const PRODUCTS = [
  ...
  },
  {
    ...
    body: 'Medium',
    flavorProfile: ['Fruity', 'Caramel', 'Chocolate'],
    brewMethods: ['Drip', 'Espresso', 'Pour-over'],
    process: 'Washed',
    altitudeMeters: 1750,
    lat: 1.85,
    lng: -76.05,
  ...
  },
  {
    ...
    body: 'Full',
    flavorProfile: ['Chocolate', 'Citrus', 'Nutty'],
    brewMethods: ['Espresso', 'Drip'],
    process: 'Washed',
    altitudeMeters: 1550,
    lat: 14.56,
    lng: -90.73,
  ...
  },
  {
    ...
    body: 'Light',
    flavorProfile: ['Berry', 'Citrus', 'Fruity'],
    brewMethods: ['Pour-over', 'Drip'],
    process: 'Washed',
    altitudeMeters: 1800,
    lat: -0.42,
  ...
  },
  {
    ...
    body: 'Full',
    flavorProfile: ['Earthy', 'Chocolate', 'Fruity'],
  ...
  },
  {
    ...
    body: 'Medium',
    flavorProfile: ['Caramel', 'Fruity', 'Nutty'],
  ...
  },
  {
    ...
    body: 'Light',
    flavorProfile: ['Floral', 'Fruity', 'Caramel'],
  ...
  },
  {
    ...
    body: 'Medium',
    flavorProfile: ['Chocolate', 'Nutty', 'Fruity'],
  ...
  },
  {
    ...
    body: 'Medium',
    flavorProfile: ['Caramel', 'Citrus', 'Nutty'],
    brewMethods: ['Drip', 'Espresso'],
    process: 'Washed',
    altitudeMeters: 1850,
    lat: -6.0,
  ...
  },
  {
    ...
    body: 'Light',
    flavorProfile: ['Fruity', 'Floral', 'Caramel'],
    brewMethods: ['Pour-over', 'Drip'],
    process: 'Washed',
    altitudeMeters: 1500,
    lat: 14.15,
  ...
  },
  {
    ...
    body: 'Full',
    flavorProfile: ['Berry', 'Chocolate', 'Fruity'],
    brewMethods: ['Drip', 'Espresso', 'Cold brew'],
    process: 'Washed',
    altitudeMeters: 1700,
    lat: -8.9,
    lng: 33.45,
  ...
  },
  {
    ...
    body: 'Light',
    flavorProfile: ['Citrus', 'Floral', 'Caramel'],
    brewMethods: ['Pour-over'],
    process: 'Washed',
    altitudeMeters: 1800,
    lat: -2.92,
  ...
  },
  {
    ...
    body: 'Full',
    flavorProfile: ['Chocolate', 'Spice', 'Nutty'],
