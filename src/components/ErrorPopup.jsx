...
/**
 * Dismissible error popup (toast). Renders nothing when `message` is falsy.
 * Closes on the × button, on Escape, or automatically after `autoDismissMs`
 * (pass 0 to disable auto-dismiss). The parent owns the message state and clears
 * it via `onClose`.
 */
